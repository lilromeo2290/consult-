...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Fine Management', page: 'penalties', icon: Gavel, group: 'Revenue' },
  ...
  { label: 'Customer Statement', page: 'individual-report', icon: UserCircle, group: 'System' },
...
const PAGE_TITLES: Record<RMSPage, string> = {
  ...
  receipts: 'Receipts',
  reports: 'Reports',
  'individual-report': 'Customer Statement',
