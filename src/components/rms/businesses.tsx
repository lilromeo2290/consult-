...
export function BusinessesPage() {
  ...
  const handlePrintCertificate = async (cert: BusinessCert) => {    const _asmSettings = (() => { try { return JSON.parse(localStorage.getItem('rms-settings-assembly') || '{}'); } catch { return {}; } })();    const dynAssemblyName = _asmSettings.name || cert.assemblyName || 'Kpando Municipal Assembly';
