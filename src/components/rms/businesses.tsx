...
export function BusinessesPage() {
  ...
  const handleSave = () => {
    ...
    try {
      ...
      const assemblyName = (() => {
        try { const r = JSON.parse(localStorage.getItem('rms-settings-assembly') || '{}'); return r.name || 'Clipe Revenue Management System'; } catch { return 'Clipe Revenue Management System'; }
      })();
    ...
    return (
      <div className="space-y-6">
        ...
        {viewingCert && (() => {
          ...
          const dynAssemblyName = _asm.name || viewingCert.assemblyName || 'Clipe Revenue Management System';
          const _dynDesc = _asm.description || '';
                    ...
                    <div style={{ margin: '35px 40px', position: 'relative', zIndex: 2 }}>
                      ...
                      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                        ...
                        <div>
                          ...
                          {_dynDesc && <div style={{ fontFamily: "'Times New Roman', serif", fontSize: '12px', color: '#444', marginTop: '6px', lineHeight: 1.4 }}>{_dynDesc}</div>}
                        </div>
                      </div>
