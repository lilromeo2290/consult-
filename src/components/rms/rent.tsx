...
export function RentPage() {
  ...
  const handleFormChange = (
    ...
    if (type === 'checkbox') {
      ...
      setForm((prev) => ({
        ...
        rentPropertyUniqueNumber: uniqueNumber,
  ...
  // ── Shared classes ──────────────────────────────────────────────────────
  const inputClass =     'w-full rounded-lg border border-slate-300 dark:border-slate-500 bg-white dark:bg-muted px-4 py-2.5 text-sm text-foreground focus:ring-2 focus:ring-primary focus:border-primary outline-none transition';
