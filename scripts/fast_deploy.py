...
r('rm -rf /home/rms-correct 2>/dev/null')
r('cd /home && git clone --depth 3 https://github.com/lilromeo2290/Rev_Mgnt_Sys.git rms-correct 2>&1',t=60)
...
ssh.close()
print('Running. Check: tail -f /tmp/correct-deploy.log')